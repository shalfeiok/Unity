...
## 2026-02-28
- Added PlayMode smoke coverage `UITogglesSmokeTest` for hotkey-intent panel toggles (I/C/P/S/K/O/M) via `UIHotkeyRouter` + windowing runtime, including Atlas mapping.
