    ...
    public static class RussianUiStrings
    {
        public static IReadOnlyDictionary<string, string> BuildDefault()
        {
            return new Dictionary<string, string>
            {
                ...
                ["event.gem_inserted_detailed"] = "Самоцвет {0} вставлен в сокет #{1}",
                ["event.gem_removed"] = "Самоцвет извлечён",
                ["event.gem_removed_detailed"] = "Самоцвет {0} извлечён из сокета #{1}",
                ["event.passive_allocated"] = "Пассивный узел выделен",
                ["event.passive_allocated_detailed"] = "Выделен пассивный узел: {0}",
                ["event.passive_refunded"] = "Пассивный узел возвращён",
                ["event.passive_refunded_detailed"] = "Возвращён пассивный узел: {0}",
                ...
                ["event.hotbar_assigned_detailed"] = "Навык {0} назначен в слот {1}",
                ["event.hotbar_unassigned"] = "Навык снят с панели",
                ["event.hotbar_unassigned_detailed"] = "Навык снят из слота {0}",
